...
probe("float_recent", pro.share_float,
      ann_date="", start_date="20260801", end_date="20260825",
      fields="ts_code,ann_date,float_date,float_share,float_ratio,holder_name")
probe("float_2024", pro.share_float,
      start_date="20240801", end_date="20240825",
      fields="ts_code,ann_date,float_date,float_share,float_ratio,holder_name")

# 2) 业绩预告 — 2026 中报期 (刚披露完) + 2024 中报期 (验深度)
probe("forecast_2026H1", pro.forecast,
      period="20260630",
      fields="ts_code,ann_date,end_date,type,p_change_min,p_change_max,net_profit_min,net_profit_max,update_flag")
probe("forecast_2024H1", pro.forecast,
      period="20240630",
