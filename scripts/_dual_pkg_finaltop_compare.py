...
(复用 scripts/_q90_slot_eval.py 已验证的闸重建/排名/真赢家口径, 2026-09-02 对拍):
...
用法:
  ...
  python scripts/_dual_pkg_finaltop_compare.py
  # 冒烟 (指定日, 仅 A 臂, q50 闸复现旧环境) + 与交付 CSV 对拍
  python scripts/_dual_pkg_finaltop_compare.py --only-dates 2026-08-19,2026-08-28,2026-08-31 --bundles a --q50-gate
"""
