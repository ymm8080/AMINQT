...
cache_2022 = pd.read_parquet(
    "data/supply_cache/alt_data/fina_indicator/all_20220101_20230701.parquet"
)
cache_2022["symbol"] = cache_2022["ts_code"].str.split(".").str[0]
cache_2022["ann_dt"] = pd.to_datetime(
    cache_2022["ann_date"], format="%Y%m%d", errors="coerce"
)

cache_2023 = pd.read_parquet(
...
cache_2023["ann_dt"] = pd.to_datetime(
    cache_2023["ann_date"], format="%Y%m%d", errors="coerce"
)
