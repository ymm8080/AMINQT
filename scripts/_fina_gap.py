...
all_df = pd.read_parquet("data/supply_cache/alt_data/fina_indicator/all_20230701_20260727.parquet")
all_df["ann_date_dt"] = pd.to_datetime(all_df["ann_date"], format="%Y%m%d", errors="coerce")
