...
class DeepSeekAgent:
    ...
    def _record_failure(self) -> None:
        ...
        if self._consecutive_failures >= _BREAKER_THRESHOLD:
            ...
            logger.error(
                ...
                self._consecutive_failures, _BREAKER_OPEN_SEC // 60,
            )
    ...
    def _tokens_exceeded(self) -> bool:
        """日 token 限额检查."""
        limit = int(self._cfg.get("daily_token_limit",
    ...
    def explain_signal(self, symbol: str, score: float,
                       top_factors: List[dict], shap: dict) -> dict:
        """1. 推理解释: 为什么选/为什么买."""
        return self._call("explain_signal", {
            "prompt": (
    ...
    def diagnose_stock(self, symbol: str, factor_pack: dict) -> dict:
        ...
        return self._call("diagnose", {
            ...
            "schema": {"trend": "str", "capital": "str", "chips": "str",
                       "risk": "str", "conclusion": "str"},
        })

    def market_sentiment_index(self, market_stats: dict) -> dict:
        """5. 市场情绪指数 (0~100)."""
        return self._call("sentiment_index", {
            "prompt": (
    ...
    def interpret_dragon_tiger(self, lhb_data: dict) -> dict:
        """6. 龙虎榜席位解读."""
        return self._call("dragon_tiger", {
            "prompt": (
                "解读龙虎榜席位行为 (游资/机构/北向): "
