...
class FeatureSelector:
    ...
    DEFAULT_CONFIG = {
        "main": {
            ...
            "force_include": [
                # [2026-09-12] 益盟 S-L 关系 + 多周斜率/持续族 (用户令免全量 A/B
                # 直接接入, 小型 A/B 验证 FAIL 再摘): OOS 20250820~20260828 股内
                # TS IC — SL标准化 +0.058 / SL差值 +0.052 达线; 斜率/持续族 = 九锚
                # 轨迹编码首测. 出货密度 5/10/20d (IC +0.077/+0.088/+0.106) main
                # pin 273 列本来就有 — 漏网的只有 dual, 已补 dual.gate_d 侧.
                "SL差值",
                "SL标准化",
                "SL斜率20",
                "SL多头持续天数",
        ...
        "dual": {
            ...
            "gate_d": {
                ...
                "force_include": [
                    ...
                    "出货_density_10d",
                    "出货_density_20d",
                    # [2026-09-12] 益盟 S-L/斜率族 7 列与 main 同注 (用户令两板一致;
                    # 同引擎同数学, IC 证据全池口径含双创). 小型 A/B FAIL → 两板一起摘.
                    "SL差值",
                    "SL标准化",
                    "SL斜率20",
                    "SL多头持续天数",
