# -*- coding: utf-8 -*-
"""
pin 特征集受控 A/B: close_vs_low_ma5/ma20 入 pin 裁决 (2026-09-09)
协议依据: feature_selector.py pin 冻结注释 — "更新 pin = 显式动作 (新特征家族落地),
人工核对 + 250d replay 通过才写新 pin". 人工核对已完成 (IC/残差/对拍/单测).
本脚本 = 250d replay: A=pin 原样 vs B=pin+2新列, main/dual 两板,
...
OUT = os.path.join(HERE, "_pin_ab_cl_0909_result.json")
NEWCOLS = ["close_vs_low_ma5", "close_vs_low_ma20"]
OOS_DAYS = 250
