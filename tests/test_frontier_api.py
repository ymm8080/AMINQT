...
class TestFrontierAPI:
    ...
    def test_watchlist_toggle(self):
        r = client.post("/api/frontier/watchlist/toggle",
    ...
    def test_backtest_run(self):
        r = client.post("/api/frontier/backtest/run",
                        json={"max_hold_days": 3, "prob_exit": 0.5})
        assert r.status_code == 200
        body = r.json()
    ...
    def test_tune_and_validation(self):
        r = client.post("/api/frontier/backtest/tune",
