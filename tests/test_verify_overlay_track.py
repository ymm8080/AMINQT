...
class TestPerDateSummary:
    def test_top_half_beats_bottom_when_score_aligned(self):
        ...
        m = _merged([
            {"board": "main", "date": "2026-08-04", "symbol": "000001",
             "final_score": 0.90, "prob_up": 0.60, "w_pool": 0.2, "w_prob": 0.8,
             "prob_col": "prob_up_3d",
             "label_mfe_2d_net": 0.03, "label_mfe_3d_net": 0.05,
             "label_mfe_5d_net": 0.08, "label_mfe_10d_net": 0.10},
            {"board": "main", "date": "2026-08-04", "symbol": "000002",
             "final_score": 0.80, "prob_up": 0.55, "w_pool": 0.2, "w_prob": 0.8,
             "prob_col": "prob_up_3d",
             "label_mfe_2d_net": 0.02, "label_mfe_3d_net": 0.03,
             "label_mfe_5d_net": 0.06, "label_mfe_10d_net": 0.09},
            {"board": "main", "date": "2026-08-04", "symbol": "000003",
             "final_score": 0.70, "prob_up": 0.50, "w_pool": 0.2, "w_prob": 0.8,
             "prob_col": "prob_up_3d",
             "label_mfe_2d_net": 0.01, "label_mfe_3d_net": 0.01,
             "label_mfe_5d_net": 0.03, "label_mfe_10d_net": 0.04},
            {"board": "main", "date": "2026-08-04", "symbol": "000004",
             "final_score": 0.60, "prob_up": 0.45, "w_pool": 0.2, "w_prob": 0.8,
             "prob_col": "prob_up_3d",
             "label_mfe_2d_net": -0.01, "label_mfe_3d_net": -0.02,
             "label_mfe_5d_net": 0.01, "label_mfe_10d_net": 0.02},
            {"board": "main", "date": "2026-08-04", "symbol": "000005",
             "final_score": 0.50, "prob_up": 0.40, "w_pool": 0.2, "w_prob": 0.8,
             "prob_col": "prob_up_3d",
             "label_mfe_2d_net": -0.03, "label_mfe_3d_net": -0.04,
             "label_mfe_5d_net": -0.01, "label_mfe_10d_net": 0.00},
        ])
    ...
    def test_no_future_data_yields_nan_n0(self):
        ...
        m = _merged([
            {"board": "dual", "date": "2026-08-04", "symbol": "300001",
             "final_score": 0.80, "prob_up": 0.60, "w_pool": 0.5, "w_prob": 0.5,
             "prob_col": "prob_up_3d",
             "label_mfe_2d_net": None, "label_mfe_3d_net": None,
             "label_mfe_5d_net": None, "label_mfe_10d_net": None},
            {"board": "dual", "date": "2026-08-04", "symbol": "300002",
             "final_score": 0.70, "prob_up": 0.55, "w_pool": 0.5, "w_prob": 0.5,
             "prob_col": "prob_up_3d",
             "label_mfe_2d_net": None, "label_mfe_3d_net": None,
             "label_mfe_5d_net": None, "label_mfe_10d_net": None},
        ])
    ...
    def test_spearman_requires_min_n(self):
        ...
        m = _merged([
            {"board": "main", "date": "2026-08-04", "symbol": f"{i:06d}",
             "final_score": i / 10, "prob_up": 0.5, "w_pool": 0.2, "w_prob": 0.8,
             "prob_col": "prob_up_3d",
...
class TestLoadSnapshots:
    def test_glob_concat(self, tmp_path):
        ...
        a.write_text("board,date,symbol,final_score\nmain,2026-08-04,000001,0.9\n",
                     encoding="utf-8")
        b.write_text("board,date,symbol,final_score\nmain,2026-08-05,000002,0.8\n",
                     encoding="utf-8")
        snap = vt.load_snapshots(tmp_path)
        assert len(snap) == 2
        assert snap["symbol"].dtype == object  # dtype=str 读回, 不丢前导零
